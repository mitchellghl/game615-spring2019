...
public class LaunchScript : MonoBehaviour {
    ...
    void Start () {
        ...
        Cube1a = GameObject.Find("Cube1a");
        Cube1b = GameObject.Find("Cube1b");
        Cube1c = GameObject.Find("Cube1c");
        Cube1d = GameObject.Find("Cube1d");

        Cube2a = GameObject.Find("Cube2a");
        Cube2b = GameObject.Find("Cube2b");
        Cube2c = GameObject.Find("Cube2c");
        Cube2d = GameObject.Find("Cube2d");

        Cube3a = GameObject.Find("Cube3a");
        Cube3b = GameObject.Find("Cube3b");
        Cube3c = GameObject.Find("Cube3c");
        Cube3d = GameObject.Find("Cube3d");
    }
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if (other.gameObject.name == "InvisibleTriggerCube") {
			ring1 = true;//In OnGUI we will print you win when this is set to true

            Cube1a.GetComponent<Renderer>().material = SuccessMaterial;
            Cube1b.GetComponent<Renderer>().material = SuccessMaterial;
            Cube1c.GetComponent<Renderer>().material = SuccessMaterial;
            Cube1d.GetComponent<Renderer>().material = SuccessMaterial;
        }

        if (other.gameObject.name == "InvisibleTriggerCube2")
        {
            ring2 = true;//In OnGUI we will print you win when this is set to true

            Cube2a.GetComponent<Renderer>().material = SuccessMaterial;
            Cube2b.GetComponent<Renderer>().material = SuccessMaterial;
            Cube2c.GetComponent<Renderer>().material = SuccessMaterial;
            Cube2d.GetComponent<Renderer>().material = SuccessMaterial;
        }

        if (other.gameObject.name == "InvisibleTriggerCube3")
        {
            ring3 = true;//In OnGUI we will print you win when this is set to true

            Cube3a.GetComponent<Renderer>().material = SuccessMaterial;
            Cube3b.GetComponent<Renderer>().material = SuccessMaterial;
            Cube3c.GetComponent<Renderer>().material = SuccessMaterial;
            Cube3d.GetComponent<Renderer>().material = SuccessMaterial;
        }
